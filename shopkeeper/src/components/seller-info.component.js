...
Change(e){
 ...
 myFunction() {
  ...
  <h4><i>TELL ME ABOUT YOUR BUSSINESS</i></h4><br />
  <div>
  <h5><i>seller information</i></h5> 
 <label><b>
    Firstname</b><br/>  
    <input style={{width: '300px'}} id="user"
   ...
   <label><b>
    ...
    value={this.state.shopname} onChange={this.shopname}
    ref={node => (this.inputNode = node)}
      required/></label>
    <br />

    <label><b>Choose shop category </b></label><br />
  <select  style={{width: '200px'}} id="categories" name="categories" placeholder="categories">
...
<h5><i>Address</i></h5>
    ...
    value={this.state.address1} onChange={this.address1}
    ref={node => (this.inputNode = node)}
   required/></label>
    <br />
   ...
   <label><b>
    ...
    value={this.state.address2} onChange={this.address2}
    ref={node => (this.inputNode = node)}
    required/></label>
    <br />
    ...
    value={this.state.city} onChange={this.city}
    ref={node => (this.inputNode = node)}
    required/></label>
    <br />
    ...
    value={this.state.state} onChange={this.check}
    ref={node => (this.inputNode = node)}
    required/></label>
    <br />
    </div>
